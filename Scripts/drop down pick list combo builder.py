...
outCSV = r"C:\GIS\Projects\Seabird\BRPE Dotting Database\template_builder.csv"

with open(outCSV, "w", newline='') as f:
	w = csv.writer(f)
	w.writerow(["SPECIES", "BIRD", "NEST", "CHICK_CLASS"])
			...
			for nest in nest_type:
				for chick in chick_type:
					if species == 'BROWN PELICAN':
						data = [species,bird,nest,chick]
						print(data)
						w.writerow(data)
					else:
						data = [species,bird,nest]
						print(data)
						w.writerow(data)
						break
